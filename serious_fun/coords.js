...
// console.dir(fun);
// console.log(fun.clientWidth, fun.clientHeight);
...
fun.appendChild(coords_g);


// create vertical lines
for(let i=0; i < fun.clientWidth; i+=50) {
  let line = document.createElementNS("http://www.w3.org/2000/svg", "line");
  line.setAttribute("x1", i);
  line.setAttribute("y1", 0);
  line.setAttribute("x2", i);
  line.setAttribute("y2", fun.clientWidth);
  line.setAttribute("stroke", "#eeeeee");
  vertical_g.appendChild(line);
}

// create horizontal lines
for(let i=0; i < fun.clientHeight; i+=50) {
  let line = document.createElementNS("http://www.w3.org/2000/svg", "line");
  line.setAttribute("x1", 0);
  line.setAttribute("y1", i);
  line.setAttribute("x2", fun.clientWidth);
...
for(let i=0; i < fun.clientWidth; i+=100) {
  ...
  text2.setAttribute("y", fun.clientHeight-15);
  text3.setAttribute("y", fun.clientHeight/2);
...
for(let i=0; i < fun.clientWidth; i+=100) {
  ...
  text2.setAttribute("x", fun.clientWidth/2+15);
  text3.setAttribute("x", fun.clientWidth-35);
